    ...
    for (int i = 0; i < fieldsToGenerate.length; i++) {
      ...
      pdf.addPage(
        pw.Page(
          ...
          margin: const pw.EdgeInsets.all(28.35), // 1cm margini dai bordi del foglio
...
class _ProgressDialogState extends State<_ProgressDialog> {
  ...
  String _getMatchTypeAbbreviation(Match match) {
    if (match.matchType.toLowerCase() == 'campionato' && match.giornata != null && match.giornata!.isNotEmpty) {
      return match.giornata!; // Mostra solo "1A" o "1R"
    }
    return match.matchType.toLowerCase() == 'torneo' ? 'T' : match.matchType.toLowerCase() == 'amichevole' ? 'A' : 'C';
  }
}